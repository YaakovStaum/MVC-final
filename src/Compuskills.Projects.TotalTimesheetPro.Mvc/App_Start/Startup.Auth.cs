...
namespace Compuskills.Projects.TotalTimesheetPro.Mvc
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(TotalTimesheetProContext.Create);
            app.CreatePerOwinContext<TtpUserManager>(Compuskills.Projects.TotalTimesheetPro.Mvc.Identity.IdentityExtensions.CreateUserManager);
            app.CreatePerOwinContext<TtpSignInManager>(TtpSignInManager.Create);
